      ...
      >
        <div className="sm-max-screen flex items-center flex-col px-6 justify-center text-center">
          ...
          <form onSubmit={(e) => {
           ...
           <div id="inputOne" className="border border-1 border-gray-700 hover:border-purple-500 w-full h-[44px] px-[16px] bg-[#1F2937]  rounded-[8px] flex gap-[15px] items-center"> 
           <CiUser className="text-2xl text-[#6E7079]" />
            <input type="text" placeholder="Username"  className="font-Montserrat text-[#ACACAC] text-[12px] w-full outline-none bg-[#1F2937]"/>
         </div> 
               <div id="inputTwo" className="bg-[#1F2937] border border-gray-700 hover:border-purple-500 w-full h-[44px] px-[16px]  rounded-[8px] flex gap-[15px] items-center"><CiLock className="text-2xl text-[#6E7079]"/>
               <input type={showtext? "text" :"password"} placeholder="password"  className="font-Montserrat text-[#ACACAC] bg-[#1F2937] text-[12px] w-[100%] outline-none h-full"/>
                
              <p onClick={handlePassword}>{showtext? <FaEye className="text-[#6E7079] w-fit"/>:<FaEyeSlash className="text-[#6E7079]"/>}</p> 
          ...
          <div className="mt-[20px] flex justify-center items-center text-center">
            <h1 className="font-Montserrat font-[400] text-[#666666]">
              ...
              <Link to="/signup" className="font-Montserrat font-[400] text-gray-300 hover:text-white">
                {" "}
                Sign Up
              </Link>
            </h1>
