...
const Starting = ({ isPlanning, setIsPlanning }) => {
  ...
  const handleShowGeminiReport = () => {
    ...
    if (!geminiReport) {
      ...
      setLoading(false); // Stop the loader if data is already available
    }
  };
  ...
  return (
    <div className="flex flex-col h-full w-full py-6 px-6 border dark:border-white border-gray-700 hover:border-purple-500 rounded-lg bg-[#1F2937]">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex gap-4">
          ...
          <button
            onClick={handleShowGeminiReport}
            className={`px-4 py-2 rounded text-sm font-semibold ${
              showGeminiReport
                ? "bg-purple-500 text-white"
                : "bg-gray-600 text-gray-300 hover:bg-gray-500"
      ...
      {!showGeminiReport && (
        <div className="w-full h-full">
          <div className="flex justify-between items-center mb-4">
            <div className="flex gap-4">
              {/* Additional buttons or UI elements can go here */}
            </div>
          </div>
          ...
          {!loading && (
            <div className="space-y-6 w-full">
              ...
              <div className="w-full m-0" style={{ margin: "unset" }}>
      ...
      {showGeminiReport && (
        <div className="w-full h-full">
          ...
          {!loading && (
            <div className="w-full max-h-[calc(100vh-200px)] overflow-y-auto custom_srollbar">
...
//             <div className="flex w-[100%] justify-between flex-col items-center mb-4">
//               {/* <div className="flex w-[100%] items-left gap-4 pb-2">
//                 <p className="dark:text-white text-gray-300 text-[14px]">Keyword Report </p>
//                 <p  className="dark:text-white text-gray-300 text-[14px]">/</p>
//                 <p className="dark:text-white text-gray-300 text-[14px]" >Gemini Report </p>
//               </div> */}

//               <div className="flex w-[100%] items-left gap-4">
//                 {!loading && !isResearching && keyWords.length > 0 && (
//                   <button
//                     onClick={handleStartResearch}
//                     className="bg-purple-500 hover:bg-purple-600 text-white font text-[14px] py-2 px-4 rounded"
