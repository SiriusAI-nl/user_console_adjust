...
const Card = ({icon,title,desc,className,rightIcon,titleClass,classIcon,classMain}) => {
  return (
    <div>
        ...
        <div className={`bg-white w-[100%] group trasition-2 gap grid border-[1px] border-[#34006114] px-[52px] py-[28px] md:flex md:flex-col rounded-[10px] hover:bg-[#340061] hover:text-[white] ${classMain}`}>
